 ...
 */
class ThreeStepWorkflowPublicationRequestsNeedingPublishingSideReport_ThisSubsite extends SideReport {
	function title() {
...
class ThreeStepWorkflowPublicationRequestsNeedingPublishingSideReport_AllSubsites extends SideReport {
	function title() {
		return _t('MyWorkflowPublicationRequestsSideReport.ALLSUBSITES',"Workflow: publication requests I need to publish (all subsites)");
	}
	function records() {
