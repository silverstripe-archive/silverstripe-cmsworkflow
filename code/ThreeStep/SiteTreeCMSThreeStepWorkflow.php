...
class SiteTreeCMSThreeStepWorkflow extends SiteTreeCMSWFDecorator implements PermissionProvider
{
     ...
     */
    public function canBatchPublish($member = null)
    {
    ...
    public function ApproverMembers()
    {
        if ($this->owner->CanApproveType == 'OnlyTheseUsers') {
            ...
            if ($this->owner->ParentID) {
                ...
                return $this->owner->SiteConfig->ApproverMembers();
            }
    ...
    public static function can_approve_multiple($ids, $memberID, $useCached = true)
    {
    ...
    public function PublisherMembers()
    {
        if ($this->owner->CanPublishType == 'OnlyTheseUsers') {
            ...
            if ($this->owner->Parent()->Exists()) {
                ...
                return $this->owner->SiteConfig->PublisherMembers();
            }
    ...
    public static function can_publish_multiple($ids, $memberID, $useCached = true)
    {
    ...
    public function onAfterWrite()
    {
        ...
        if ($this->owner->CanApproveType == 'OnlyTheseUsers' && !$this->owner->ApproverGroups()->Count()) {
            ...
            $groupCheckObj = DataObject::get_one('Group', "{$bt}Code{$bt} = '{$SQL_group}'");
            if ($groupCheckObj) {
                $this->owner->ApproverGroups()->add($groupCheckObj);
            }
        }
     ...
     * @return void
     */
    public function augmentDefaultRecords()
    {
