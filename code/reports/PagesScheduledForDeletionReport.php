...
class PagesScheduledForDeletionReport extends SSReport {
	...
	function columns() {
		$fields = array(
			...
			'AbsoluteLink' => array(
				'title' => 'URL',
				'formatting' => '$value " . ($AbsoluteLiveLink ? "<a href=\"$AbsoluteLiveLink\">(live)</a>" : "") . " <a href=\"$value?stage=Stage\">(draft)</a> <a href=\"$AbsoluteLiveLink?futureDate=$ExpiryDate\">(view on expiry date)</a>'
			),
			"BacklinkCount" => array(
