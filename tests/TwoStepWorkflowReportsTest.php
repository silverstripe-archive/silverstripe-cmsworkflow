...
class TwoStepWorkflowReportsTest extends FunctionalTest
{
    ...
    public static $fixture_file = 'cmsworkflow/tests/TwoStepWorkflowReportsTest.yml';
    ...
    public function testDeletionRequestsINeedToApproveReport()
    {
    ...
    public function testPublicationRequestsINeedToApproveReport()
    {
    ...
    public function testMyRequestsPendingReview()
    {
